...
class VaDE(nn.Module):
    def __init__(self, args):
        ...
        self.mu_c = nn.Parameter(
            torch.FloatTensor(args.nClusters, args.hid_dim).fill_(0), requires_grad=True
        )
    ...
    def pre_train(self, dataloader, pre_epoch=10):
        ...
        if not os.path.exists("./pretrain_model.pk"):
            ...
            gmm = GaussianMixture(
                n_components=self.args.nClusters, covariance_type="diag"
            )
    ...
    def ELBO_Loss(self, x, L=1):
        ...
        loss = recon_loss + second_term - third_term

        return loss, recon_loss, second_term, third_term
